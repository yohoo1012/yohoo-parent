...
import yo.hoo.support.widget.ClickLayout;
...
@Connect(value = ClickLayout.class, loadStyle = LoadStyle.EAGER)
public class ClickLayoutConnector extends AbstractLayoutConnector {
